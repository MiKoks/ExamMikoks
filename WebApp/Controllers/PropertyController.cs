...
namespace WebApp.Controllers
{
    ...
    public class PropertyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Address,PictureUrl,Id")] Property @property)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Address,PictureUrl,Id")] Property @property)
        {
            if (id != @property.Id)
            {
                return NotFound();
